...
const (
	DemoService_GetDemo_FullMethodName = "/proto.demo.v1.DemoService/GetDemo"
)
...
func (c *demoServiceClient) GetDemo(ctx context.Context, in *GetDemoRequest, opts ...grpc.CallOption) (*GetDemoResponse, error) {
	...
	err := c.cc.Invoke(ctx, DemoService_GetDemo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.demo.v1.DemoService",
